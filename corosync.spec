...
Version  : 3.1.3
Release  : 5
URL      : https://github.com/corosync/corosync/releases/download/v3.1.3/corosync-3.1.3.tar.gz
Source0  : https://github.com/corosync/corosync/releases/download/v3.1.3/corosync-3.1.3.tar.gz
Source1  : https://github.com/corosync/corosync/releases/download/v3.1.3/corosync-3.1.3.tar.gz.asc
Summary  : corosync
...
%prep
%setup -q -n corosync-3.1.3
cd %{_builddir}/corosync-3.1.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1622130049
...
cp %{_builddir}/corosync-3.1.3/LICENSE %{buildroot}/usr/share/package-licenses/corosync/87bb10215fd2b4c06b1ba1072ffea5ae7eae1800
%make_install
